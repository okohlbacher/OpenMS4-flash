...
/////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////
START_SECTION([EXTRA] isotope scoring entry points preserve the shared Core result)
{
  ...
  TEST_REAL_SIMILAR(SpectralDeconvolution::getCosine(intensities, 1, 3, reference, 1, 2), 1.0)
  ...
  int core_offset = -99;
  int flash_offset = -99;
  const float core_score = PeakGroupScoring::getIsotopeCosineAndIsoOffset(1000.0, shifted, core_offset, avg, 0, -1, {});
  const float flash_score = SpectralDeconvolution::getIsotopeCosineAndIsoOffset(1000.0, shifted, flash_offset, avg, 0, -1, {});
  TEST_REAL_SIMILAR(flash_score, core_score)
  TEST_EQUAL(flash_offset, core_offset)
  TEST_EQUAL(flash_offset, 1)
}
END_SECTION
