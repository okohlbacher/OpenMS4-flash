...
namespace OpenMS
{
  ...
  {
    return PeakGroupScoring::getIsotopeCosineAndIsoOffset(mono_mass, per_isotope_intensities,
      offset, avg, iso_int_shift, window_width, excluded_masses);
  }
  ...
  {
    return PeakGroupScoring::getCosine(a, a_start, a_end, b, offset, min_iso_len);
  }
