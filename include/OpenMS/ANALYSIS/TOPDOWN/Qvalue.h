...
#include <OpenMS/ANALYSIS/TOPDOWN/OpenMSFLASHConfig.h>
...
namespace OpenMS
{
  ...
  /**
@brief   Qvalue : contains functions to calculate Qvalues from deconvolution quality score (Qscore) defined in PeakGroupScoring
@ingroup Topdown
*/

  class OPENMSFLASH_DLLAPI Qvalue
  {
  public:
    ...
    /// @param[out] deconvolved_spectra target and decoy deconvolved spectra
